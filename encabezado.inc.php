        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              ...
              <?php if($_SESSION['Usuario_IdNivel'] == 1) {?><!-- valido si es administrador -->
                <span>Administrador</span>
              <?php }?>
              <?php if($_SESSION['Usuario_IdNivel'] == 2) {?><!-- valido si es Operador -->
                <span>Operador</span>
              <?php }?>
              <?php if($_SESSION['Usuario_IdNivel'] == 3) {?><!-- valido si es Chofer -->
                <span>Chofer</span>
              <?php }?>
