...
if (!empty($_POST['BotonLogin'])) {
    ...
    if ( !empty($UsuarioLogueado)) {
       ...
       //generar los valores del usuario (esto va a venir de mi BD)
        ...
        $_SESSION['Usuario_IdNivel']      =   $UsuarioLogueado['IDNIVEL'];
        ...
        $Mensaje='Datos incorrectoss, ingresa nuevamente.';
    }
                  ...
                  <form class= "row g-3 needs-validation" novalidate method='post'>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input class="form-control" type="email" name="user" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      ...
                      <input class="form-control" type="password" id="yourPassword" name="password" required>
                      <div class="invalid-feedback">Ingresa tu clave</div>
                    </div>

                
                    <div class="col-12">
                      <button type="submit" class="btn btn-primary w-100" value="Login" name="BotonLogin">Login</button>
                    </div>
                  </form>
